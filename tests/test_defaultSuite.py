...
class TestDefaultSuite():
  ...
  def test_smoketest(self):
    ...
    assert len(elements) > 0
    self.driver.find_element(By.NAME, "fname").send_keys("efra")
    self.driver.find_element(By.NAME, "lname").send_keys("perez")
    self.driver.find_element(By.NAME, "bizname").send_keys("hola")
    self.driver.find_element(By.NAME, "biztitle").send_keys("sr")
    self.driver.find_element(By.NAME, "submit").click()
    elements = self.driver.find_elements(By.NAME, "email")
    assert len(elements) > 0
    self.driver.find_element(By.LINK_TEXT, "Admin").click()
    self.driver.find_element(By.ID, "username").click()
    self.driver.find_element(By.ID, "username").send_keys("hola")
